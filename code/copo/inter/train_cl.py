...
if __name__ == "__main__":
    ...
    config = dict(
        ...
        env=get_rllib_compatible_env(get_change_n_env(MultiAgentIntersectionEnv)),
        env_config=dict(
            start_seed=tune.grid_search([5000, 6000, 7000, 8000, 9000, 10000, 11000, 12000]), num_agents=30
        ),
